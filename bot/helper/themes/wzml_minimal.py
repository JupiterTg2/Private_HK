...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'σωηєя'
    ST_BN1_URL = 'https://t.me/JUPITERxTG'
    ST_BN2_NAME = 'υρ∂αтєѕ'
    ST_BN2_URL = 'https://t.me/NSKBOTS'
    ST_MSG = '''<i>Im A leech & Mirror Bot With some features.</i>'''
    ST_BOTPM = '''<i>Now, I will send all your files and links here...</i>'''
    ST_UNAUTH = '''<i>Im A leech & Mirror Bot With some features.</i>'''
